  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.lowerPart}>
        <View style={{flex:1}}>
        <View style={{height:hp("8%"),justifyContent:'flex-end',marginLeft:hp("2%")}}>
          <Text style={{fontSize:24, opacity:0.8}}>Lets get going</Text>
        </View>
        ...
        <View style={{height:hp("8%"),borderTopWidth:1,flexDirection:'row',borderTopColor:'#d9d9d9',justifyContent:'center',alignItems:'center'}}>
          ...
          <Text style={{fontSize:wp("3.6%"),paddingLeft:wp("15%")}}>Don't have an account ? </Text>
          </View>
