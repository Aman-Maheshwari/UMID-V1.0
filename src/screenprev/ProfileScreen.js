                    ...
                    />
                        ...
                        <View style={styles.backgroundContainerLower}>
                            ...
                            <View style={{ justifyContent: "center", alignItems: "center", marginTop: wp('2%') }}>
                                ...
                                <TouchableOpacity onPress={() => {
                                    this.props.navigation.navigate('RegisterShop',{selectionComplete: this.state.category})
                                }}>
                                    {/* <Text style={{fontSize:18}}>If you are a vendor</Text> */}
      ...
      />
                    ...
                    <KeyboardAvoidingView behavior="padding" style={{ flex: 1 }} enabled>
                        ...
                        <View style={styles.backgroundContainerLower}>
                            ...
                            <TextInput style={styles.TextInput}
                                // value = {this.state.phone}
                                onChangeText={(text) => this.props.dispatch({ type: 'UPDATE_PHONE', text: text })}
                            // editable={false}
                            />
                            <Text style={styles.TextLabels}>Organisation</Text>
                            <TextInput style={styles.TextInput}
                            ...
                            >
                                {/* <Text style={{fontSize : 22,marginTop:hp('2%'),alignSelf:'center',color:'#0290ea',fontWeight:'bold'}}>
                                    SAVE
                                </Text> */}
                                <TouchableOpacity
                                    onPress={() => {
                                        this.setState({ isEditable: false })
                                        ToastAndroid.show("Profile Saved!!", 800)
                                    }}
                                >
                                    <Image
