...
//               <TextInput
//                 style={{ height: hp("5%"), fontSize: 16, marginBottom: 10, borderBottomColor: 'grey', borderBottomWidth: 0.5 }}
...
//                     <Text style={{ fontSize: 12, color: "#0290ea" }}>Food Supplies</Text>
//                   </View>
//                 </TouchableOpacity>
//                 <TouchableOpacity onPress={() => {
...
//                     <Text style={{ fontSize: 12, color: "#0290ea" }}>Emotional Support</Text>
//                   </View>
//                 </TouchableOpacity>
//                 <TouchableOpacity onPress={() => {
...
//                     <Text style={{ fontSize: 12, color: "#0290ea" }}>Others</Text>
//                   </View>
//                 </TouchableOpacity>
//               </View>
//               <TextInput
//                 style={{ borderWidth: 0.5, marginBottom: 20, height: hp("20%"), borderColor: 'grey', borderRadius: 4 }}
//                 multiline={true}
//                 numberOfLines={5}
...
//             <Text style={{ color: '#0290ea', fontSize: wp('3%'), marginBottom: wp('5%') }}>
