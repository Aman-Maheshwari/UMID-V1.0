...
// import { StyleSheet, Text, View, Button, Alert, Keyboard, TouchableOpacity,RefreshControl, Dimensions, Image, ScrollView, Animated, FlatList, TextInput, KeyboardAvoidingView, Linking, BackHandler, ActivityIndicator } from 'react-native';
                ...
                <Marker
                  ...
                  onPress={() => {
                    ...
                    // YASH UPDATED WHOLE ELSE, TAKE IT
                      ...
                      this.setState({
                        isMarkerClicked: true,
                        markerClickedid: marker.phonenumber + '-' + marker.timestamp
                      })
                      // console.log('MARKER Clicked', this.state.markerClickedid)
                      this.handdlePress()
                    }
