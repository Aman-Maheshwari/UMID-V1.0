...
// //             const itemDataEmailId = item.Email ? item.Email.toUpperCase() : ''.toUpperCase();
// //             const textDataEmailId = text.toUpperCase();
// //             const itemDataOrgName = item.OrganisationName ? item.OrganisationName.toUpperCase() : ''.toUpperCase();
...
//             <View style={styles.container}>
//                 <View style={{ flexDirection: 'row', marginLeft: wp("3%") }}>
//                     <View style={{ height: hp('6%'), justifyContent: 'center', alignItems: 'center', marginRight: wp("3%") }}>
//                         <Image
//                             source={require('../assets/search.png')}
//                         />
//                     </View>
...
export default class FoodSupplies extends React.Component {
    ...
    render() {
        ...
        borderWidth: 1,
        opacity: .6,
        borderRadius: 10,flexDirection:'row',width:wp("88%")}}>
                    <TextInput style={styles.TextInput}
