...
class ChatList extends Component {
    ...
    componentDidMount() {
        ...
        var fetchMessage = new Promise((resolve, reject) => {
            var fetchedAno = []
            firebase.database().ref("ChatsUnderYou/Anonymous/" + this.props.phonenumberuser + "/").on("value", snapshot => {
                // console.log("fetching form anonymous = ",snapshot.val());
    ...
    SearchFilterFunction(text) {
        ...
        this.arrayholder.forEach((item) => {
            ...
            const itemDescr = item.description ? item.description.toUpperCase() : ''.toUpperCase();
            const textDesc = text.toUpperCase();

            // console.log("ite description = ",itemDescr);
            
            if (itemData.indexOf(textData) > -1)
                foundObj.push(item)

            if(itemDescr.indexOf(textDesc) >-1)
                foundObj.push(item)
        ...
        if (this.state.display == true) {
            ...
            if (this.state.isLoading == false) {
                ...
                <AnonymousDrawer />
                            ...
                            <View style={{ flex: 1, backgroundColor: "#fff" }}>
                                <View style={{
                                    marginTop: hp("3%"), flexDirection: 'row', borderColor: 'grey',
                                    borderWidth: 1,
                                    opacity: .6,
                                    ...
                                    <TextInput
                                        ...
                                        onChangeText={(text) => {
                                            ...
                                            this.setState({
                                                ...
                                                if (this.state.text == "") {
                                                    console.log("when text is empty = ",this.arrayholder);
                                        ...
                                        <View>
                                            <FlatList
                                                ...
                                                renderItem={({ item }) => (
                                                    ...
                                                    <View>
                                                    {/* { console.log("item inside list = ",item,"flatlistShow = ",this.state.showFlatList)} */}
                                                        {/* {console.log("incremnet", i++)} */}
                                                        {item.category == "Emotional Support" && item.softDelete == false?
                                                                ...
                                                                {this.state.Blocked == false ?
                                                                    <View style={styles.renderChatsName1}>
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <View style={{
                                                                                flexDirection: 'column', borderBottomWidth: 0.25,
                                                                                borderBottomColor: "grey", height: hp("7%"), width: wp("53%")
                                                                            }}>
                                                                                <Text style={styles.textStyle}>Anonymous</Text>
                                                                                <Text style={{ fontSize: 14 }} numberOfLines={1} ellipsizeMode="tail">({item.description})</Text>
                                                                            </View>
                                                                        ...
                                                                        {/* <Text>{item.counter}</Text> */}
                                                                        <View style={{
                                                                            width: wp("40%"), alignItems: 'center', justifyContent: "center", borderBottomWidth: 0.25,
                                                                            borderBottomColor: "grey", height: hp("7%")
                                                                        }}>
                                                                            {
